    ...
    setParentHeight: function () {
        ...
        $(context.nav.parent).each(function (i, val) {
            ...
            $parent.children(context.switcher.slide).each(function (j, slides) {
                ...
                height = $slide.height();
                is_variable = context.isVaryHeight(
                    $slide.parent(context.switcher.body)
                );
    ...
    go: function (id, to) {
        ...
        styles.arrows.each(function (i, nav) {
            ...
            if (loc > -1) {
                ...
                $arrow
                    .attr(context.attr.to, newID)
                    .attr(context.attr.active, active);
            } else {
...
$(
    ...
    slider.go($parent.attr(slider.attr.id), $el.attr(slider.attr.to));
});
